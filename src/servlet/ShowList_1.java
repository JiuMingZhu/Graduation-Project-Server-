...
/**
 * Servlet implementation class ShowList_1
 */
@WebServlet("/ShowList_1")
public class ShowList_1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (httpSession.getAttribute("loginStatus") == null) {
			...
			if(httpSession.getAttribute("loginStatus").equals("false")){
				...
				// TODO Auto-generated method stub
				// 生成静态的Html
				String filePath = this.getServletContext().getRealPath("").replace("\\", "/") + "List1.html";
				...
				String sesql = "select sourceId,sourceName from sourceList_1";
				...
				try {
					...
					while (rs.next()) {
						...
						// 采用隐藏表单实现
						sb.append("<tr><td>" + "<form name=form" + i + " action=./ShowList_2 method=post>"
				...
				out.close();
				response.sendRedirect("List1.html");
			}
		}
	}
}
