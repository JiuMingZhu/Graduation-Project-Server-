...
@WebServlet("/ShowList_2")
public class ShowList_2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// TODO Auto-generated method stub
		// 生成静态的Html
		String filePath = this.getServletContext().getRealPath("").replace("\\", "/") + "List2.html";
...
//		从数据库中读取相关的信息，然后写入到html中
		...
		try {
			...
			while (rs.next()) {
				...
				// 采用隐藏表单实现
				sb.append("<tr><td>" + "<form name=form" + i + " action=ShowList_3 method=post>"
